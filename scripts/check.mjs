...
const required = [
  ...
  "RL-environment/plump/model/plump-ppo-14200-int8.onnx",
  "RL-environment/plump/model/plump-ppo-14200-int8.json",
  "RL-environment/plump/model/plump-oracle-14200-int8.onnx",
  "RL-environment/plump/model/plump-oracle-14200-int8.json",
  "styles.css",
  "site-config.js",
  "site-navigation.js",
  "script.js",
