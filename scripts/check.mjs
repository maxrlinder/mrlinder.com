...
const required = [
  ...
  "RL-environment/plump/model/plump-ppo-100500-ev-fp16.json",
  "RL-environment/plump/model/plump-oracle-100500-ev-fp32.onnx",
  "RL-environment/plump/model/plump-oracle-100500-ev-fp32.json",
  "RL-environment/plump/model/plump-rl6-15300-ev-fp32.onnx",
  "RL-environment/plump/model/plump-rl6-15300-ev-fp32.json",
  "RL-environment/plump/model/plump-rl6-15300-ev-fp16.onnx",
  "RL-environment/plump/model/plump-rl6-15300-ev-fp16.json",
  "RL-environment/plump/model/plump-rl6-oracle-15300-ev-fp32.onnx",
  "RL-environment/plump/model/plump-rl6-oracle-15300-ev-fp32.json",
  "styles.css",
  "site-config.js",
  "site-navigation.js",
  "script.js",
