...
const required = [
  ...
  "RL-environment/plump/model/plump-ppo-97100-ev-fp32.onnx",
  "RL-environment/plump/model/plump-ppo-97100-ev-fp32.json",
  "RL-environment/plump/model/plump-ppo-97100-ev-fp16.onnx",
  "RL-environment/plump/model/plump-ppo-97100-ev-fp16.json",
  "RL-environment/plump/model/plump-oracle-97100-ev-fp32.onnx",
  "RL-environment/plump/model/plump-oracle-97100-ev-fp32.json",
  "styles.css",
  "site-config.js",
  "site-navigation.js",
  "script.js",
